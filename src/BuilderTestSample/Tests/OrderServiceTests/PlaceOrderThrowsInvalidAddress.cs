    ...
    public class PlaceOrderThrowsInvalidAddress : BaseOrderServiceTests
    {
        ...
        public void GivenNoStreet1()
        {
            var order = _orderBuilder
                ...
                .BuildCustomer(cb => cb.WithTestValues()
                    .BuildAddress(ab => ab.WithTestValues().Street1("")))
                .Build();
        ...
        public void GivenNoState()
        {
            var order = _orderBuilder
                .WithTestValues()
                .BuildCustomer(cb => cb.WithTestValues()
                    .BuildAddress(ab => ab.WithTestValues().State(null)))
                .Build();
        ...
        public void GivenNoPostalCode()
        {
            var order = _orderBuilder
                .WithTestValues()
                .BuildCustomer(cb => cb.WithTestValues()
                    .BuildAddress(ab => ab.WithTestValues().PostalCode(null)))
                .Build();
        ...
        public void GivenNoCountry()
        {
            var order = _orderBuilder
                .WithTestValues()
                .BuildCustomer(cb => cb.WithTestValues()
                    .BuildAddress(ab => ab.WithTestValues().Country(null)))
                .Build();
